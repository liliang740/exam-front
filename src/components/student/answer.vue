            ...
            <transition name="slider-fade">
                <div class="left" v-if="slider_flag">
                    ...
                    <div class="l-bottom">
                        ...
                        <el-button type="primary" style="width: 100%;font-size: 22px;margin: 25px 0 0 0;" icon="el-icon-a-061" @click="finishExam()">结束考试</el-button>
                    </div>
                </div>
            </transition>
            <!--右边选择答题区-->
                ...
                <div class="right">
                    ...
                    <div class="content">
                        ...
                        <div v-if="currentType == 1">
                            ...
                            <div
                                class="analysis"
                                v-if="isPractice && radio[index] != undefined"
                            >
                                <ul>
                                    <li>
                                        <el-tag type="success"
                        ...
                        <div class="fill" v-if="currentType == 2">
                            <div
                                v-for="(item, currentIndex) in part"
                                :key="currentIndex"
                            >
                                <el-input
                                    placeholder="请填在此处"
