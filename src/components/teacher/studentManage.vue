...
<template>
  <div class="all">
    <el-form :inline="true" class="demo-form-inline">
      ...
      <el-form-item>
        <el-button type="primary" @click="getStudentGrade" icon="el-icon-a-042" style="font-size: 20px;">查询</el-button>
      </el-form-item>
    </el-form>
    ...
    <el-table :data="pagination.records" border>
      ...
      <el-table-column fixed="right" label="操作" width="240">
        <template slot-scope="scope">
          <el-button @click="checkGrade(scope.row.studentId)" type="primary" icon="el-icon-a-032">编辑</el-button>
          <el-button @click="deleteById(scope.row.studentId)" type="danger" icon="el-icon-a-022">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
